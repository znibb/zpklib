...
# Creates the httplib file for use in Kicad to access the external HTTP library

LIB_FILE_NAME=zpklib

set -euo pipefail

read -r -p "Enter the domain where your Inventree instance is hosted (as DOMAIN.TLD): " url
